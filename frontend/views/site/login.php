    ...
    <div class="form-wrap">
        <div class="form-toper">
            <?php
                ...
                $leftmenu = [
                    ['label' => '每天十分钟，看些有意思的', 'url' => ['/site/index'], 'options' => ['class' => 'login-title']],
                ];
                echo Nav::widget([
        ...
        <div class="main-content">
            <div class="form-area">
                <div class="form-menu">
                    <?=Html::a('登录', ['site/login'], ['class' => 'actived']);?><?= Html::a('注册',['site/signup']);?>
                </div>
                <div class="form-content">
                    ...
                    <?= Html::submitButton('登录', ['class' => 'btn btn-login']); ?>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
        </div>
