...
<div class="cont-acc">
    <div class="contacc-top">
        ...
        <div class="contacctop-right">
            <span class="contacctop-name"><?php echo Html::a($value['user']['nickname'], ['home/u', 'id' => $value['user']['id']]) ?></span><span class="contacctop-behavior"><?php echo date('m月d H:i', $value['created_at']); ?></span>
        </div>
    </div>
