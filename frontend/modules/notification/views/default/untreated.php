    ...
    <div class="submissions-toper">
        <div class="row">
            ...
            <div class="col-sm-4" style="text-align: right;">
                <input type="checkbox" name="untreated-submissions" checked="true">只看未处理投稿
            </div>
        </div>
    </div>
<?php 
...
<script type="text/javascript">
    ...
    .click(function(){
        var url = '<?php echo 'index.php?r=notification/default/submissions&id='.$data['id'].'&name='.$data['name'] ?>';
        $.ajax({
            url: url,
            type: 'get',
        }).always(function(result){
